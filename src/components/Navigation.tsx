        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <div className="relative">
              <Cpu className="h-6 w-6 text-primary-glow transition-transform duration-base group-hover:rotate-180" />
            </div>
          ...
          <div className="hidden md:flex items-center gap-1">
            {navLinks.map((link) => (
              <Link
                key={link.path}
                to={link.path}
                className={`relative px-3 py-2 text-sm font-medium transition-colors duration-base rounded-lg ${
